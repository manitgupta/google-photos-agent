...
from google_photos import create_post
load_dotenv()
...
async def list_tools() -> list[mcp_types.Tool]:
  ...
  print(f"MCP Server: Received list_tools request. \n MCP Server: Advertising tool: {mcp_tool_schema_post}")
  return [mcp_tool_schema_post]
...
if __name__ == "__main__":
  ...
  try:
    asyncio.run(uvicorn.run(starlette_app, host=APP_HOST, port=APP_PORT, log_level="debug"))
